        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryName = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationUsers_Users_TargetUserId",
                        column: x => x.TargetUserId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EvaluationUsers_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    PostText = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Connection = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentPosts", x => x.CommentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReactPosts", x => x.ReactId);
                    table.ForeignKey(
                        ...
                        principalColumn: "PostId");
                    table.ForeignKey(
                        name: "FK_ReactPosts_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationUsers_TargetUserId",
                table: "EvaluationUsers",
                column: "TargetUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationUsers_UserId",
                table: "EvaluationUsers",
                column: "UserId");
